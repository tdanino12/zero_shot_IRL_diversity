...
POLICY_POOL_PATH = "/home/tom.danino/scevel/ZSC-Eval/zsceval/policy_pool"
...
def extract_sp_S1_models(layout, exp, env="Overcooked"):
    ...
    print(run_ids)
    print("########################################################")
    path = "/home/tom.danino/ZSC/results/Overcooked/random0/mappo/hsp-S1/wandb/"
    ...
    for r_i, run_id in enumerate(run_ids):
        ...
        if run.state == "finished":
            ...
            folder = "/home/tom.danino/ZSC/results/Overcooked/random0/mappo/hsp-S1/wandb/"+folder+"/files/"
            print("###")
            print(folder, run_id)
            print("###")
            ...
            for tag, exp_version in selected_pts.items():
                ...
                tmp_dir = f"/home/tom.danino/tmp/{layout}/{exp}"
                for pt in actor_pts:
                    print("here!!!!!!!!!!!!!!!")
